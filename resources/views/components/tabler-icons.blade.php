<div class="tabler-search-bar">
    <input type="text" name="tabler_search" placeholder="Type to search" autocomplete="off">
</div>
<div class="tabler-box">
    <div class="tabler-icons">
        ...
        <div class="tabler-icon">
            ...
            <strong>currency-bath</strong>
            <div class="tabler-icon-codes">
                <code>ti ti-currency-bath</code><br>
                <code>\ee52</code>
            </div>
        </div>
        ...
        <div class="tabler-icon">
            ...
            <div class="tabler-icon-codes">
                <code>ti ti-letters-case</code><br>
                <code>\ec6a</code>
            </div>
        </div>
        ...
        <div class="tabler-icon">
            ...
            <strong>vector-beizer-2</strong>
            <div class="tabler-icon-codes">
                <code>ti ti-vector-beizer-2</code><br>
                <code>\ed3a</code>
            </div>
        </div>
